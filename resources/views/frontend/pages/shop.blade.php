...
@section('script')
  ...
  $("#slider-range").slider({
    ...
    slide: function (event, ui) {
      var formattedMin = ui.values[0].toLocaleString("vi-VN");
      var formattedMax = ui.values[1].toLocaleString("vi-VN");
      $("#amount").val("đ" + formattedMin + " - đ" + formattedMax);
      $('#price_start').val(ui.values[0])
      $('#price_end').val(ui.values[1])
    }
  });

  var formattedMinDefault = $( "#slider-range" ).slider( "values", 0 ).toLocaleString("vi-VN");
  var formattedMaxDefault = $( "#slider-range" ).slider( "values", 1 ).toLocaleString("vi-VN");
  $( "#amount" ).val( "đ" + formattedMinDefault + " - đ" + formattedMaxDefault );
});
