...
use App\Http\Controllers\BotManController;//botchat
...
//     return view('frontend.botman.welcome');
// });
Route::match(['get', 'post'], '/botman', [BotManController::class, 'handle']);

// Route::get('/api/get-chat-history', 'BotManController@getChatHistory');
// Route::post('/api/save-chat-history', 'BotManController@saveChatHistory');
